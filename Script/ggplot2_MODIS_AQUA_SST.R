...
#MODIS AQUA Sea surface temperature plot
#Tuan-Anh Bui
...
install.packages(c("raster","ncdf4","rasterVis","zoo","tidyverse","rgdal","sf","RColorBrewer"))
...
(f <- list.files(path = paste0("C:/Users/TABU/Desktop/wget/MODIS_Aqua_Monthly_SST_01.2006_04.2019","/"), pattern="*.L3m_MO_SST_sst_4km.nc",full.names=T))
...
#Set break of the legend
#Set break from 16 to 32 
legend_break <- c(seq(from = 16,to = 32, by = 2))
...
for (i in 1:length(year_list)) { 
  ...
  plot <- ggplot() +
    ...
    #Adjust lables
    labs(
      title = "MODIS AQUA Sea surface temperature (°C)", #Title 
    ...
    scale_fill_gradientn(
      name = "Sea surface temperature (°C)", #Title of the legend
  ...
  ggsave(path = paste0("C:/Users/TABU/Desktop/Tuan-Anh Bui/2_Deep sea/R_analysis/Figures/MODIS_AQUA_SST_2006_2019","/"),
         filename = paste("AQUA_MODIS_SST_",year_list[i],".png"), scale=2,
         plot = last_plot(),
  ...
  #ggsave(path = paste0("C:/Users/TABU/Desktop/Tuan-Anh Bui/2_Deep sea/R_analysis/Figures/MODIS_AQUA_SST_2006_2019","/"),
  #       filename = paste("AQUA_MODIS_SST_",year_list[i],".pdf"), scale=2,
  #      plot = last_plot(),
